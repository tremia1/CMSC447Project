...
class Congratulations extends Phaser.Scene {
    ...
    create() {
        ...
        //Add texts
        this.text = this.add.text(200, 50, "Congratulations!", { color: 'white', fontFamily: 'strong', fontSize: '60px', fontStyle: 'bold' }).setShadow(2, 2, 'black', 2, false, true);
        this.text1 = this.add.text(215, 150, "You helped Coco and Koko escape\n from cobblestone forest!", { color: 'white', fontFaamily: 'strong', fontSize: '20px' }).setShadow(2, 2, 'black', 2, false, true)

        this.name = this.getName();


        //Thank users (the dog will say this it will bark)
        this.thankyoudog = this.add.text(125, 485, 'Thank you, --', { color: 'white', fontFamily: 'cursive', fontSize: '15px', backgroundColor: 'transparent', fontStyle: 'bold', strokeThickness: 2, stroke: 'black' }).setPadding(10, 10).setVisible(false)
        this.thankyoucat = this.add.text(520, 485, 'Thank you, --', { color: 'white', fontFamily: 'fantasy', fontSize: '15px', backgroundColor: 'transparent', fontStyle: 'bold', strokeThickness: 2, stroke: 'black' }).setPadding(10, 10).setVisible(false)
        ...
        this.leaderboardtext = this.add.text(250, 300, "Press Space to go to Leaderboard", { color: 'black', fontFamily: 'Arial', fontSize: '20px', backgroundColor: 'white' })
